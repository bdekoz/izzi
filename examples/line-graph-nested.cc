...
test_chart()
{
  ...
  svg_element anno = make_line_graph_annotations(agraph, vunion, gsa, 1000);
  ...
  // Draw graph(s).
  svg_element chart1 = make_line_graph(agraph, vr1, gs1, rangex, rangey);
  svg_element chart2 = make_line_graph(agraph, vr2, gs2, rangex, rangey);
