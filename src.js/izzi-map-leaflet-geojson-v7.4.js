// deepthink 20260330
// baseline-v7.4 - Function-generated geojson map with new window wrapper
// Fixes: gzip decompression inside the map, title generation for week-* files,
//        and correct URL passing.
...
function leaflet_map_geojson(geojsonUrl) {
    ...
    function getTitleFromUrl(url) {
        ...
        fileName = fileName.replace(/\.(geojson|zip|gz|gzip)+$/i, ''); // strip all extensions
