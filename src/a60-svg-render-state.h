  ...
  enum class select : ulong
    {
     ...
     image		= 1u << 2, ///< image
     raster		= 1u << 3, ///< raster (pixel) elements
     vector		= 1u << 4, ///< svg path, circle, rectangle, etc.
     blur		= 1u << 5, ///< blur or gradient version of vector
     echo		= 1u << 6, ///< b & w outline version of vector
     text		= 1u << 7, ///< metadata, header
     title		= 1u << 8, ///< title
     legend		= 1u << 9, ///< text and symbol legends
     axis		= 1u << 10, ///< axes
     grid		= 1u << 11, ///< grid
     linex		= 1u << 12, ///< horizontal lines
     liney		= 1u << 13, ///< vertical lines
     ticks		= 1u << 14, ///< ticks, markers
     tooltip		= 1u << 15, ///< tooltips meta layer
     telecom		= 1u << 16, ///< telecom infrastructure
     tor		= 1u << 17, ///< tor exit node infrastructure
     satellite		= 1u << 18, ///< megaconstellation satellite
     cable		= 1u << 19, ///< fiber optic
     glyph		= 1u << 20, ///< glyph
     svg		= 1u << 21, ///< svg element, perhaps nested
     alt		= 1u << 22, ///< alternate use specified in situ
